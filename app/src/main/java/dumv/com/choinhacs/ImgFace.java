...
public class ImgFace extends ImageView {
    ...
    public ImgFace(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ImgFace(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            setOutlineProvider(new ImgFace.OutlineProvider());
        }
